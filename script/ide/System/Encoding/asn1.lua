...
--- The decoder class
------------------------------------
local ASN1Decoder = commonlib.gettable("System.Encoding.ASN1Decoder")

function ASN1Decoder:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
    return o
...
function ASN1Decoder:setStopOnError(val)
	self.stoponerror = val
end
		
--- Registers the base simple type decoders
function ASN1Decoder:registerBaseDecoders()
	self.decoder = {}
...
local ASN1Encoder = commonlib.gettable("System.Encoding.ASN1Encoder")
new = function(self,o)
        o = o or {}
        setmetatable(o, self)
        self.__index = self
...
function Encoding.BERtoInt(class, constructed, number)
