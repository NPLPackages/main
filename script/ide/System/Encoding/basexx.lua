--[[
Title: base32/base16/base64
Author(s): ported to NPL by LiXizhi, from https://github.com/aiq/basexx/blob/master/lib/basexx.lua
Desc: 
Use Lib:
-------------------------------------------------------
NPL.load("(gl)script/ide/System/Encoding/basexx.lua");
local basexx = commonlib.gettable("System.Encoding.basexx");

assert(basexx.to_base32("hello world")=="nbswy3dpeb3w64tmmq");
assert(basexx.from_base32("nbswy3dpeb3w64tmmq")=="hello world");
-------------------------------------------------------
]]
...
-- @param enablePadding: true to enable padding with ====, on multiple of 5
function basexx.to_base32( str, enablePadding )
   return to_basexx( str, base32Alphabet, 5, enablePadding and base32PadMap[ #str % 5 + 1 ] or "")
end
