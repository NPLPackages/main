...
Title: CRC32
Author(s): LiXizhi
Desc: A faster file based version is in ParaIO.CRC32
...
function Encoding.crc32(str)
    ...
    while count > 0 do
        ...
        crc = bxor(rshift(crc, 8), CRC32[bxor(band(crc, 0xFF), byte) + 1])
        i = i + 1
        count = count - 1
    end
