...
--end
--
--mlp.expr:add{ "`", adt, builder = mlp.fget(1) }

--------------------------------------------------------------------------------
-- Anonymous lambda
--------------------------------------------------------------------------------
local lambda_expr = gg.sequence{ 
   "|", func_params_content, "|", mlp.expr,
   builder= function (x) 
...
--------------------------------------------------------------------------------
--local function expr_in_backquotes (lx) return mlp.expr(lx, 35) end
--
--mlp.expr.infix:add{ name = "infix function", 
...
-- By Xizhi: disabled this one it conflicts with binary expression 0<-1
--------------------------------------------------------------------------------

--mlp.lexer:add "<-"
--mlp.stat.assignments["<-"] = function (a, b)
