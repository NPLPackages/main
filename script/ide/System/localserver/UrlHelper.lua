...
System.localserver.UrlHelper.WS_to_REST("www.paraengine.com/getPos.asmx", {uid=123, pos = {x=1, y=2}}, {"uid", "pos.x", "pos.y"});
System.localserver.UrlHelper.BuildURLQuery("profile.html", {uid=123, show=true});
System.localserver.UrlHelper.IsDefaultPort("http", 80)
-------------------------------------------------------
]]
...
function UrlHelper.IsDefaultPort(scheme, port) 
	return (System.localserver.HttpConstants.DefaultSchemePortMapping[scheme] == port)
end
