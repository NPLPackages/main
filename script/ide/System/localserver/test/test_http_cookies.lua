...
use the lib:
------------------------------------------------------------
NPL.load("(gl)script/ide/System/localserver/test/test_http_cookies.lua");
test_cookiemap()
-------------------------------------------------------
]]

NPL.load("(gl)script/ide/System/localserver/http_cookies.lua");
...
function test_cookiemap()
	...
	for i, case in ipairs(testcases) do
		log("case "..i.."\n")
		log("in: "..case.in_.."\n")
		local CookieMap = System.localserver.CookieMap:new(case.in_)
