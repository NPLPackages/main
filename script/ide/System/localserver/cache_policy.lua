...
local cache_policy = System.localserver.CachePolicy:new("access plus 1 month");
cache_policy:IsExpired(ParaGlobal.GetSysDateTime()-80000);

-- there are some premade policies, which can be retrieve from System.localserver.CachePolicies, see below
local cp = System.localserver.CachePolicies["never"];
local cp = System.localserver.CachePolicies["always"];
local cp = System.localserver.CachePolicies["1 hour"];
...
local CachePolicies = {
	-- never cache
	["never"] = System.localserver.CachePolicy:new("access plus 0"),
	-- common cache policies
	["1 hour"] = System.localserver.CachePolicy:new("access plus 1 hour"),
	["1 day"] = System.localserver.CachePolicy:new("access plus 1 day"),
	["1 month"] = System.localserver.CachePolicy:new("access plus 1 month"),
	["1 week"] = System.localserver.CachePolicy:new("access plus 1 week"),
	-- always from cache
	["always"] = System.localserver.CachePolicy:new("access plus 1 year"),
} 
commonlib.setfield("System.localserver.CachePolicies", CachePolicies);
