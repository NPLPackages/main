...
function painter:DrawCircle(cx,cy,cz, radius, axis, bFill, segment, fromAngle, toAngle, center_offset)
	ShapesDrawer.DrawCircle(self, cx,cy,cz, radius, axis, bFill, segment, fromAngle, toAngle, center_offset);
end