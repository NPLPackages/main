--[[
Title: tinyyaml - YAML subset parser
Author(s): LiXizhi, 
Date: 2018/10/13
Desc: ported from https://github.com/peposso/lua-tinyyaml

use the lib:
------------------------------------------------------------
NPL.load("(gl)script/ide/System/Util/tinyyaml.lua");
local tinyyaml = commonlib.gettable("System.Util.tinyyaml");
local docs = tinyyaml.parse("styleID: 0\nquiz:\n  data:\n    - id: accf6330-c243-11e8-a186-cde1c58e088c\n      type: '2'\n")
echo(docs)
------------------------------------------------------------
]]
local tinyyaml = commonlib.gettable("System.Util.tinyyaml");
