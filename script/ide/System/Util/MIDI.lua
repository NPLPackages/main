--[[
    Title: midi file prase
    author:{https://pjb.com.au/comp/lua/MIDI.html}
    time:2022-12-01
    uselib:
        NPL.load("(gl)script/ide/System/Util/MIDI.lua");
        local MIDI = commonlib.gettable("System.Util.MIDI");
]]

--require 'DataDumper'   -- http://lua-users.org/wiki/DataDumper
local M = commonlib.gettable("System.Util.MIDI") -- public interface
M.Version = 'VERSION'
