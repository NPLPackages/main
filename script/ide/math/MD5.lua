...
assert(md5:MD5('') == 'd41d8cd98f00b204e9800998ecf8427e')
assert(md5:MD5(s0) == 'f96b697d7cb7938d525a2f31aaf161d0')
-------------------------------------------------------
]]

NPL.load("(gl)script/ide/math/bit.lua");

local major, minor = "MD5", "$Rev: 61644 $"

local lib, oldMinor = commonlib.LibStub:NewLibrary(major, minor)
if not lib then return end

local bit_bor, bit_band, bit_bxor = mathlib.bit.bor, mathlib.bit.band, mathlib.bit.bxor
local bit_lshift, bit_rshift, bit_mod = mathlib.bit.lshift, mathlib.bit.rshift, math.fmod
